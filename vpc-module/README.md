...
| [aws_route.firewall_internet_gateway_ipv6](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
...
| [aws_route.private_ipv6_igw](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
| [aws_route.private_nat_gateway](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
| [aws_route.protected](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
| [aws_route.protected_v6](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
| [aws_route_table.firewall](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table) | resource |
| [aws_route_table.ingress](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table) | resource |
...
| [aws_vpn_gateway_route_propagation.firewall](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpn_gateway_route_propagation) | resource |
...
| <a name="input_create_igw"></a> [create\_igw](#input\_create\_igw) | Controls if an Internet Gateway is created for firewall subnets and the related routes that connect them. | `bool` | `true` | no |
| <a name="input_create_private_internet_gateway_route"></a> [create\_private\_internet\_gateway\_route](#input\_create\_private\_internet\_gateway\_route) | Controls if an internet gateway route for Internet private subnets should be created | `bool` | `true` | no |
| <a name="input_create_private_subnet_route_table"></a> [create\_private\_subnet\_route\_table](#input\_create\_private\_subnet\_route\_table) | Controls if separate route table for private subnets should be created | `bool` | `true` | no |
...
| <a name="input_default_network_acl_name"></a> [default\_network\_acl\_name](#input\_default\_network\_acl\_name) | Name to be used on the Default Network ACL | `string` | `"default-acl"` | no |
...
| <a name="input_external_nat_ips"></a> [external\_nat\_ips](#input\_external\_nat\_ips) | List of EIPs to be used for `nat_firewall_ips` output (used in combination with reuse\_nat\_ips and external\_nat\_ip\_ids) | `list(string)` | `[]` | no |
...
| <a name="input_firewall_endpoint_id_subnet_id_mapping"></a> [firewall\_endpoint\_id\_subnet\_id\_mapping](#input\_firewall\_endpoint\_id\_subnet\_id\_mapping) | The Subnet\_id where the firewall vpc-endpoint is created. This is used to ensure the firewall vpc\_id used for routing is associated with the route table in the corresponding subnet | `list(string)` | n/a | yes |
| <a name="input_firewall_endpoint_ids"></a> [firewall\_endpoint\_ids](#input\_firewall\_endpoint\_ids) | The identifier of the firewall endpoint that AWS Network Firewall has instantiated in the subnet. You use this to identify the firewall endpoint in the VPC route tables, when you redirect the VPC traffic through the endpoint. | `list(string)` | n/a | yes |
...
| <a name="input_firewall_subnet_assign_ipv6_address_on_creation"></a> [firewall\_subnet\_assign\_ipv6\_address\_on\_creation](#input\_firewall\_subnet\_assign\_ipv6\_address\_on\_creation) | Assign IPv6 address on public subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map\_public\_ip\_on\_launch | `bool` | `null` | no |
...
| <a name="input_ingress_route_table_tags"></a> [ingress\_route\_table\_tags](#input\_ingress\_route\_table\_tags) | Additional tags for the protected route tables | `map(string)` | `{}` | no |
...
| <a name="input_one_nat_gateway_per_az"></a> [one\_nat\_gateway\_per\_az](#input\_one\_nat\_gateway\_per\_az) | Should be true if you want only one NAT Gateway per availability zone. Requires `var.azs` to be set, and the number of `firewall_subnets` created to be greater than or equal to the number of availability zones specified in `var.azs`. | `bool` | `false` | no |
...
| <a name="input_private_subnets_mapping"></a> [private\_subnets\_mapping](#input\_private\_subnets\_mapping) | Ordered list of subnet names. The order should be set to match the output of the private\_subnets variable, as established by its CIDR function, i.e the first CIDR block returned by the function will cause the subnet to be named as per the first value of the private\_subnets\_mapping (this variable) and so on. | `list(string)` | n/a | yes |
| <a name="input_propagate_firewall_route_tables_vgw"></a> [propagate\_firewall\_route\_tables\_vgw](#input\_propagate\_firewall\_route\_tables\_vgw) | Should be true if you want route table propagation | `bool` | `false` | no |
...
| <a name="input_protected_route_table_tags"></a> [protected\_route\_table\_tags](#input\_protected\_route\_table\_tags) | Additional tags for the protected route tables | `map(string)` | `{}` | no |
| <a name="input_protected_subnet_assign_ipv6_address_on_creation"></a> [protected\_subnet\_assign\_ipv6\_address\_on\_creation](#input\_protected\_subnet\_assign\_ipv6\_address\_on\_creation) | Assign IPv6 address on protected subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map\_public\_ip\_on\_launch | `bool` | `null` | no |
| <a name="input_protected_subnet_ipv6_prefixes"></a> [protected\_subnet\_ipv6\_prefixes](#input\_protected\_subnet\_ipv6\_prefixes) | Assigns IPv6 protected subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list | `list(string)` | `[]` | no |
| <a name="input_protected_subnet_suffix"></a> [protected\_subnet\_suffix](#input\_protected\_subnet\_suffix) | Suffix to append to firewall subnets name | `string` | `"protected"` | no |
| <a name="input_protected_subnet_tags"></a> [protected\_subnet\_tags](#input\_protected\_subnet\_tags) | Additional tags for the protected subnets | `map(string)` | `{}` | no |
| <a name="input_protected_subnets"></a> [protected\_subnets](#input\_protected\_subnets) | A list of protected subnets inside the VPC | `list(string)` | `[]` | no |
...
| <a name="input_subnets_prefix"></a> [subnets\_prefix](#input\_subnets\_prefix) | Prefix to Subnet name | `string` | n/a | yes |
...
| <a name="output_protected_route_table_association_ids"></a> [protected\_route\_table\_association\_ids](#output\_protected\_route\_table\_association\_ids) | List of IDs of the protected route table association |
| <a name="output_protected_route_table_ids"></a> [protected\_route\_table\_ids](#output\_protected\_route\_table\_ids) | List of IDs of protected route tables |
